 ...
 * print-all-winners.c++
 *
 * Prints a nicely formatted LaTeX document of all the winners of
 * the PSPC Contest. 
 * 
 * This utility is most copy pasted from print-winners.c.
 * For the revision history of that source check print-winners.c
 * directly.
 *
 * *********************************************************/
#include <stdio.h>
